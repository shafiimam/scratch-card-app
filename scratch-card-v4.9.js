 ...
 */ (function (e) {
  ...
  function r(C) {
    ...
    if (j !== D) {
      C[0] = j;
      e: for (var q = 0, _ = C.length, z = _ >>> 1; q < z; ) {
        var $ = 2 * (q + 1) - 1,
          L = C[$],
          w = $ + 1,
          b = C[w];
        if (0 > o(L, j))
          w < _ && 0 > o(b, L)
            ? ((C[q] = b), (C[w] = j), (q = w))
            : ((C[q] = L), (C[$] = j), (q = $));
        else if (w < _ && 0 > o(b, j)) (C[q] = b), (C[w] = j), (q = w);
        else break e;
      }
    }
    return D;
    ...
    (e.unstable_scheduleCallback = function (C, D, j) {
      ...
      return (
        ...
        j > q
          ...
          : ((C.sortIndex = _), t(u, C), v || S || ((v = !0), Ce(x))),
        C
      );
    }),
        ...
        for (var c = a, h; c !== null; ) {
          ...
          if (
            (h.tag === 5 &&
              y !== null &&
              ((h = y),
              d !== null && ((y = Yr(c, d)), y != null && g.push(to(c, y, h)))),
            E)
          )
            break;
          c = c.return;
      ...
      e: {
        ...
        if (
          ...
          if (
            ...
            t: {
              for (g = S, d = v, c = 0, h = g; h; h = Mn(h)) c++;
              for (h = 0, y = d; y; y = Mn(y)) h++;
              for (; 0 < c - h; ) (g = Mn(g)), c--;
              for (; 0 < h - c; ) (d = Mn(d)), h--;
              for (; c--; ) {
...
function Rd(e) {
      ...
      : c !== null &&
        (c.elementType === x ||
          (typeof x == 'object' &&
            ...
            x.$$typeof === Kt &&
            mc(x) === c.type))
      ? ((y = o(c, h.props)), (y.ref = Pr(d, c, h)), (y.return = d), y)
      : ((y = ni(h.type, h.key, h.props, null, d.mode, y)),
        (y.ref = Pr(d, c, h)),
        (y.return = d),
        y);
  }
  ...
  function f(d, c, h, y) {
    ...
    if (typeof h == 'object' && h !== null) {
      ...
      if (zr(h) || Sr(h)) return x !== null ? null : m(d, c, h, y, null);
      Io(d, h);
    }
    return null;
  }
  function S(d, c, h, y, x) {
    ...
    if (typeof y == 'object' && y !== null) {
      ...
      if (zr(y) || Sr(y)) return (d = d.get(h) || null), m(c, d, y, x, null);
      Io(c, y);
    }
    return null;
  }
      ...
      switch (h.$$typeof) {
        ...
        case Bn:
          e: {
            ...
            (c = ts(h, d.mode, y)), (c.return = d), (d = c);
          }
          return l(d);
        case Kt:
          return (P = h._init), E(d, c, P(h._payload), y);
      }
      if (zr(h)) return v(d, c, h, y);
      if (Sr(h)) return g(d, c, h, y);
      Io(d, h);
    }
    return (typeof h == 'string' && h !== '') || typeof h == 'number'
      ? ((h = '' + h),
        c !== null && c.tag === 6
          ...
          : (n(d, c), (c = es(h, d.mode, y)), (c.return = d), (d = c)),
        l(d))
      : n(d, c);
  }
  return E;
...
function Cc(e, t, n, r, o) {
  ...
  if ((rr(t, o), t.stateNode === null))
    ...
    s !== p || f !== v || Xe.current || Qt
      ? (typeof S == 'function' && (Bs(t, n, S, r), (v = t.memoizedState)),
        (a = Qt || pc(t, n, a, r, f, v, u) || !1)
          ? (m ||
...
function tg(e) {
          ...
          case 59:
            if (
              ...
              switch (
                ...
                0 < C &&
                  (Et = s(1, B, z, _, ee, K, le.length, L, w, L)) !== void 0 &&
        ...
        case 10:
          T === 47
            ...
            : 1 + Z === 0 &&
              ...
              0 < B.length &&
              (($e = 1), (B += '\0')),
            0 < C * j && s(0, B, z, _, ee, K, le.length, L, w, L),
            (K = 1),
            ee++;
          break;
        case 59:
          ...
          switch ((K++, (qe = $.charAt(Y)), U)) {
            ...
            case 108:
              if (X + T + b + ne === 0 && 0 < we)
                switch (Y - we) {
                  case 2:
                    ve === 112 && $.charCodeAt(Y - 3) === 58 && (ne = ve);
                  case 8:
                    he === 111 && (ne = he);
                }
              break;
  ...
  function n(_, z, $) {
    ...
    switch (b) {
      ...
      default:
        var G = (T = 0);
        for (z = []; T < w; ++T)
          for (var X = 0; X < b; ++X) z[G++] = r(_[X] + ' ', L[T], $).trim();
    }
    return z;
  }
  function r(_, z, $) {
    ...
    switch ((33 > L && (L = (z = z.trim()).charCodeAt(0)), L)) {
      case 38:
        return z.replace(d, '$1' + _.trim());
      case 58:
        return _.trim() + z.replace(d, '$1' + _.trim());
      default:
        if (0 < 1 * $ && 0 < z.indexOf('\f'))
          return z.replace(d, (_.charCodeAt(0) === 58 ? '' : '$1') + _.trim());
    }
    return _ + z;
  }
  function o(_, z, $, L) {
    ...
    if (b === 944) {
      _ = w.indexOf(':', 9) + 1;
      var T = w.substring(_, w.length - 1).trim();
      return (
        (T = w.substring(0, _).trim() + T + ';'),
      ...
      case 953:
        if (I.test(_) === !0)
          return (T = _.substring(_.indexOf(':') + 1)).charCodeAt(0) === 115
            ? o(_.replace('stretch', 'fill-available'), z, $, L).replace(
                ':fill-available',
                ':stretch'
              )
            : w.replace(T, '-webkit-' + T) +
  ...
  function i(_, z) {
    var $ = _.indexOf(z === 1 ? ':' : '{'),
      L = _.substring(0, z !== 3 ? $ : 10);
    return (
      ($ = _.substring($ + 1, _.length - 1)),
      D(z !== 2 ? L : L.replace(A, '$1'), $, z)
    );
  }
  function l(_, z) {
    var $ = o(z, z.charCodeAt(0), z.charCodeAt(1), z.charCodeAt(2));
    return $ !== z + ';'
      ? $.replace(R, ' or ($1)').substring(4)
      : '(' + z + ')';
  }
  function s(_, z, $, L, w, b, T, G, X, Z) {
    for (var U = 0, ve = z, he; U < C; ++U)
      switch ((he = ae[U].call(m, _, ve, $, L, w, b, T, G, X, Z))) {
        case void 0:
        case !1:
        case !0:
        case null:
    ...
    switch (_) {
      ...
      default:
        if (typeof _ == 'function') ae[C++] = _;
          ...
          for (var z = 0, $ = _.length; z < $; ++z) u(_[z]);
        else j = !!_ | 0;
    }
    return u;
  }
  ...
  function m(_, z) {
    ...
    if ((33 > $.charCodeAt(0) && ($ = $.trim()), (q = $), ($ = [q]), 0 < C)) {
      var L = s(-1, z, $, $, ee, K, 0, 0, 0, 0);
      L !== void 0 && typeof L == 'string' && (z = L);
    }
    var w = t(Ce, $, z, 0, 0);
    return (
      0 < C &&
        ((L = s(-2, w, $, $, ee, K, w.length, 0, 0, 0)),
        L !== void 0 && (w = L)),
      (q = ''),
      (ne = 0),
      (K = ee = 1),
...
function Bp(e, t, n) {
  var r = ma(e),
    ...
    u =
      s === void 0
        ? (function (c, h) {
            var y = typeof c != 'string' ? 'sc' : rs(c);
            os[y] = (os[y] || 0) + 1;
            var x = y + '-' + Dp('5.3.8' + y + os[y]);
            return h ? h + '-' + x : x;
    ...
    function s(u) {
      ...
      return (
        Object.keys(a).forEach((S) => {
          ...
          if (v != null)
            if (typeof v == 'object')
              if (l[S]) f = Vr(f, e(S, v, i, l));
              else {
                const g = bt({ theme: i }, v, (E) => ({ [S]: E }));
                Ay(g, v) ? (f[S] = t({ sx: v, theme: i })) : (f = Vr(f, g));
              }
            else f = Vr(f, e(S, v, i, l));
        }),
        qg(p, f)
      );
    }
...
function c1(e = {}) {
  ...
  return (
    (o.__mui_systemSx = !0),
    (i, l = {}) => {
      Zg(i, (h) => h.filter((y) => !(y != null && y.__mui_systemSx)));
      const {
          name: s,
          slot: u,
...
const fv = ul('MuiButtonBase', ['root', 'disabled', 'focusVisible']),
  ...
  gv = N.forwardRef(function (t, n) {
    const r = Tl({ props: t, name: 'MuiButtonBase' }),
      ...
      C = N.useRef(null),
      D = Dc(C, ne),
      { isFocusVisibleRef: j, onFocus: q, onBlur: _, ref: z } = Z0(),
      [$, L] = N.useState(!1);
    a && $ && L(!1),
...
function Bv() {
  ...
  ne.includes('mobile') && b
    ? ((_ = mf(q, D, j)), console.log('mobile device', { willShowWidget: _ }))
    : ne.includes('desktop') && !b
    ? ((_ = mf(q, D, j)), console.log('desktop device', { willShowWidget: _ }))
    : ((_ = !1), console.log('widget will not show'));
  var T;
  console.log('sc app', { isMobile: b, deviceWidth: w, willShowWidget: _ }),
    N.useEffect(() => {
      _ &&
        (K
          ? (r(ee),
            console.log('scratch card ref', $),
