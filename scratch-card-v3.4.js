  ...
  [
                ...
                q = function(e) {
                  ...
                  if (Array.isArray(e) && p > 0) {
                    ...
                    (f = [].concat(
                      Object(r.a)(e),
                      Object(r.a)(v)
                    )).raw = [].concat(Object(r.a)(e.raw), Object(r.a)(v));
                  } else
                    "function" === typeof e &&
                      e.__emotion_real !== e &&
                      (f = function(t) {
    ...
    function(e, t, n) {
      ...
      function Ge(e) {
        ...
        var t,
          n = Ne[e];
        for (t in n) if (n.hasOwnProperty(t) && t in je) return (De[e] = n[t]);
        return e;
      }
      B &&
      ...
      var At,
        ...
        Et = new Map(),
        kt = [],
        Bt = "mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput close cancel copy cut paste click change contextmenu reset submit".split(
          " "
        ),
      ...
      Lt(
        ...
        Lt(Ut, 2);
      for (
        var Nt = "change selectionchange textInput compositionstart compositionend compositionupdate".split(
            " "
          ),
          Dt = 0;
        Dt < Nt.length;
      ...
      function Qr(e, t) {
        ...
        return Zr || null == jr || jr !== un(n)
          ? null
          : ("selectionStart" in (n = jr) && dn(n)
            ...
            Jr && Lr(Jr, n)
              ? null
              : ((Jr = n),
                ((e = Jn.getPooled(Dr.select, Gr, e, t)).type = "select"),
                (e.target = jr),
                Wn(e),
                e));
      }
      ...
      function ji(e, t) {
        return (e = Di(e)), Ci(e, t);
      }
      function Gi(e, t, n) {
        return (e = Di(e)), Ei(e, t, n);
      }
      function Ji(e) {
      ...
      function Ya() {
        ...
        return (
          null === Ga ? (Da.memoizedState = Ga = e) : (Ga = Ga.next = e), Ga
        );
      }
      function Ha() {
        if (null === ja) {
        ...
        var t = null === Ga ? Da.memoizedState : Ga.next;
        if (null !== t) (Ga = t), (ja = e);
        else {
          ...
          (e = {
            ...
            null === Ga ? (Da.memoizedState = Ga = e) : (Ga = Ga.next = e);
        }
        return Ga;
      }
      function _a(e, t) {
          ...
          do {
            ...
            if (s < Na) {
              ...
              null === u ? ((l = u = f), (a = r)) : (u = u.next = f),
                s > Da.expirationTime && ((Da.expirationTime = s), gu(s));
            } else
              null !== u &&
                (u = u.next = {
                  expirationTime: 1073741823,
      ...
      function ao(e, t, n, r) {
        ...
        (Da.effectTag |= e), (i.memoizedState = no(1 | t, n, a, r));
      }
      function oo(e, t) {
        return io(516, 4, e, t);
      }
      ...
      function mo(e, t, n) {
        ...
        if (
          ...
          (Ja = !0), (i.expirationTime = Na), (Da.expirationTime = Na);
        else {
          if (
            0 === e.expirationTime &&
              ...
              (t =
                1073741823 === t
                  ...
                  : Gi(
                      ...
                      function e(t, n) {
                        nu = 0;
                        if (n) return (n = ru()), Du(t, n), uu(t), null;
                        var r = lu(t);
                        if (0 !== r) {
        ...
        for (;;) {
          try {
            if ((ta(), (Ua.current = bo), Ja))
              for (var n = Da.memoizedState; null !== n; ) {
                var r = n.queue;
      ...
      function Ou(e, t, n) {
        ...
        null !== r && r.delete(t),
          Fl === e && Il === n
            ? Xl === Pl || (Xl === Sl && 1073741823 === Wl && Li() - jl < Gl)
              ? du(e, Il)
              : (Dl = !0)
            : Uu(e, n) &&
              ...
              if (X) {
                ...
                t
                  ...
                  : (console.log(
                    ...
                    ($.current.image.src = "https://cdn.jsdelivr.net/gh/shafiimam/scratch-card-app/scratch-card-style/".concat(
                      F.split(" ").join("-"),
                      ".png"
                    )));
              }
