...
(window.webpackJsonp = window.webpackJsonp || []).push([
  ...
  [
    ...
    function (e, t, n) {
      ...
      n(0), n(36), n(4), n(38), n(24), n(35), n(13);
      var r = n(19);
      n(18);
      var a = function () {
        var e = function () {
    ...
    63: function (t, e, r) {
      ...
      var y = function () {
        var t = Object(o.useState)(!1),
          ...
          g = y[0],
          m = y[1],
          w = localStorage.getItem("scratchCardConfig"),
          b = (w = JSON.parse(w)),
          x = b.shopConfig,
          E = b.discountCodes;
        console.log("\ud83d\ude80 ~ file: App.js:7 ~ App ~ shopConfig", x);
        var L = Math.floor(4 * Math.random()),
          j = localStorage.getItem("currentSessionScratchCardCode");
        (null !== j && void 0 !== j) ||
          localStorage.setItem("currentSessionScratchCardCode", L);
        var O = E[Number(j)],
          S = localStorage.getItem("productHandle"),
          _ = x["product-selection"],
          C = x["selected-products"],
          k = "selected-products" === _,
          N = !0,
          I = Object(o.useRef)(null);
        Object(o.useEffect)(function () {
          return (
            console.log("container width", I.current.offsetWidth),
            m(I.current.offsetWidth),
            function () {}
          );
        }, []),
          k &&
                ...
                h.a,
                {
                  sx: {
                    ...
                    ".ScratchCard__Container": {
                      border: "".concat(z, "px solid ").concat(A),
                ...
                i.a.createElement(
                  ...
                  i.a.createElement(
                    ...
                    i.a.createElement(
                      ...
                      {
                        variant: "h6",
                        sx: { fontSize: "".concat(D, "px"), color: F },
                      },
                      O
                    ),
                    i.a.createElement(
                ...
                switch ((t.prev = t.next)) {
                  case 0:
                    ...
                    return (
                      ...
                      (t.next = 5),
                      fetch(
                        "http://localhost:1115/public/shopConfig?shop=".concat(
                          "awesome-sauce-123.myshopify.com"
                        )
                      ).then(function (t) {
                        return t.json();
