...
const Bt = Np(S),
  ca = bp({ __proto__: null, default: Bt }, [S]);
/**
 * @license React
 ...
 */ (function (e) {
  ...
  function r(B) {
    ...
    if (x !== F) {
      B[0] = x;
      e: for (var N = 0, Q = B.length, zt = Q >>> 1; N < zt; ) {
        var Ae = 2 * (N + 1) - 1,
          dt = B[Ae],
          Fe = Ae + 1,
          ke = B[Fe];
        if (0 > i(dt, x))
          Fe < Q && 0 > i(ke, dt)
            ? ((B[N] = ke), (B[Fe] = x), (N = Fe))
            : ((B[N] = dt), (B[Ae] = x), (N = Ae));
        else if (Fe < Q && 0 > i(ke, x)) (B[N] = ke), (B[Fe] = x), (N = Fe);
        else break e;
      }
    }
    return F;
  ...
  function w(B, F) {
    ...
    try {
      for (
        A(F), p = n(s);
        p !== null && (!(p.expirationTime > F) || (B && !T()));

      ) {
        var N = p.callback;
        if (typeof N == "function") {
          (p.callback = null), (d = p.priorityLevel);
          var Q = N(p.expirationTime <= F);
          (F = e.unstable_now()),
    ...
    (e.unstable_scheduleCallback = function (B, F, x) {
      ...
      switch (
        (typeof x == "object" && x !== null
          ? ((x = x.delay), (x = typeof x == "number" && 0 < x ? N + x : N))
          : (x = N),
        B)
      ) {
        case 1:
...
function OA(e) {
  if (yt && typeof yt.onCommitFiberRoot == "function")
    try {
      yt.onCommitFiberRoot(Vo, e, void 0, (e.current.flags & 128) === 128);
    } catch {}
}
...
function cr(e, t) {
  e.blockedOn === t &&
    ...
    au ||
      ((au = !0),
      Je.unstable_scheduleCallback(Je.unstable_NormalPriority, NA)));
}
function Tr(e) {
  function t(i) {
    return cr(i, e);
  ...
  for (; 0 < Wt.length && ((n = Wt[0]), n.blockedOn === null); )
    If(n), n.blockedOn === null && Wt.shift();
}
...
function ls(e, t, n, r) {
  if ($i) {
    ...
    else if (bA(i, e, t, n, r)) r.stopPropagation();
...
function Ka() {
  Er && (Er.detachEvent("onpropertychange", Tf), (Wr = Er = null));
}
function Tf(e) {
  if (e.propertyName === "value" && Bo(Wr)) {
    var t = [];
    Xf(t, Wr, e, ns(e)), mf(yg, t);
  }
}
function Cg(e, t, n) {
  e === "focusin"
    ? (Ka(), (Er = t), (Wr = n), Er.attachEvent("onpropertychange", Tf))
    : e === "focusout" && Ka();
}
function Vg(e) {
...
var bf = Eo("animationend"),
  Nf = Eo("animationiteration"),
        ...
        for (var c = a, A; c !== null; ) {
          ...
          if (
            (A.tag === 5 &&
              h !== null &&
              ((A = h),
              f !== null && ((h = zr(c, f)), h != null && v.push(br(c, h, A)))),
            E)
          )
            break;
          c = c.return;
...
function Ua(e, t, n, r, i) {
  for (var o = t._reactName, l = []; n !== null && n !== r; ) {
    ...
    u.tag === 5 &&
      ...
      ((u = a),
      i
        ? ((s = zr(n, o)), s != null && l.unshift(br(n, s, u)))
        : i || ((s = zr(n, o)), s != null && l.push(br(n, s, u)))),
      (n = n.return);
  }
...
var vu = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  Og =
    typeof queueMicrotask == "function"
      ...
      : typeof Wa < "u"
      ? function (e) {
          return Wa.resolve(null).then(e).catch(zg);
        }
      : vu;
function zg(e) {
  setTimeout(function () {
...
function tn() {
  if (!Il && Rt !== null) {
    ...
    try {
      ...
      throw (Rt !== null && (Rt = Rt.slice(e + 1)), Cf(rs, tn), i);
    } finally {
      (D = t), (Il = !1);
    }
  }
      ...
      return (
        (t =
          t.nodeType !== 1 || n.toLowerCase() !== t.nodeName.toLowerCase()
            ...
            : t),
        t !== null
          ? ((e.stateNode = t), (Ne = e), (be = Zt(t.firstChild)), !0)
          : !1
      );
    case 6:
      return (
        (t = e.pendingProps === "" || t.nodeType !== 3 ? null : t),
        t !== null ? ((e.stateNode = t), (Ne = e), (be = null), !0) : !1
      );
    case 13:
      return (
  ...
  if (Y) {
    ...
    if (t) {
      ...
      if (!Na(e, t)) {
        ...
        t && Na(e, t)
          ? _f(r, n)
          : ((e.flags = (e.flags & -4097) | 2), (Y = !1), (Ne = e));
      }
    } else {
      if (yu(e)) throw Error(R(418));
      (e.flags = (e.flags & -4097) | 2), (Y = !1), (Ne = e);
...
function Ci(e) {
  ...
  } else be = Ne ? Zt(e.stateNode.nextSibling) : null;
  return !0;
}
function $f() {
...
var Wg = Ot.ReactCurrentBatchConfig;
function lt(e, t) {
  if (e && e.defaultProps) {
...
function id(e) {
  ...
  function s(f, c, A, h) {
    ...
    return w === Pn
      ...
      : ((h = bi(A.type, A.key, A.props, null, f.mode, h)),
        (h.ref = dr(f, c, A)),
        (h.return = f),
        h);
  }
  ...
  function p(f, c, A) {
    ...
    if (typeof c == "object" && c !== null) {
      switch (c.$$typeof) {
        case fi:
          return (
            (A = bi(c.type, c.key, c.props, null, f.mode, A)),
            (A.ref = dr(f, null, c)),
            (A.return = f),
            A
          );
        case kn:
          return (c = Tl(c, f.mode, A)), (c.return = f), c;
        case Ut:
          var h = c._init;
      ...
      switch (A.$$typeof) {
        ...
        case kn:
          e: {
            ...
            (c = Tl(A, f.mode, h)), (c.return = f), (f = c);
          }
          return l(f);
        case Ut:
...
function ws(e, t) {
  switch ((G(Jr, t), G(Gr, e), G(wt, ii), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
function At() {
  ...
  return ae === null ? (_.memoizedState = ae = e) : (ae = ae.next = e), ae;
}
function tt() {
  if (ue === null) {
    var e = _.alternate;
  ...
  var t = ae === null ? _.memoizedState : ae.next;
  if (t !== null) (ae = t), (ue = e);
  else {
    ...
    (ue = e),
      ...
      ae === null ? (_.memoizedState = ae = e) : (ae = ae.next = e);
  }
  return ae;
}
function Mr(e, t) {
...
function rc(e, t, n, r, i) {
  ...
  if ((Nn(t, i), t.stateNode === null))
    Wi(e, t), rd(t, n, r), Ru(t, n, r, i), (r = !0);
  else if (e === null) {
    var l = t.stateNode,
      u = t.memoizedProps;
    l.props = u;
...
function Su(e, t, n, r, i, o) {
  Id(e, t);
  var l = (t.flags & 128) !== 0;
  if (!r && !l) return i && ba(t, n, !1), Ft(e, t, o);
  ...
  switch ((ps(t), t.tag)) {
    ...
    case 5:
      ...
      if (((n = t.type), e !== null && t.stateNode != null))
        ...
        if (((e = sn(wt.current)), Ci(t))) {
          (r = t.stateNode), (n = t.type);
          var o = t.memoizedProps;
          switch (((r[mt] = t), (r[Nr] = o), (e = (t.mode & 1) !== 0), n)) {
            case "dialog":
    ...
    case 6:
      if (e && t.stateNode != null) Xd(e, t, e.memoizedProps, r);
        ...
        if (((n = sn(Jr.current)), sn(wt.current), Ci(t))) {
          if (
            ((r = t.stateNode),
            (n = t.memoizedProps),
            (r[mt] = t),
      ...
      return t.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((t.child.flags |= 8192),
            t.mode & 1 &&
              (e === null || H.current & 1 ? se === 0 && (se = 3) : Os())),
...
function Ud(e) {
  ...
  t !== null && ((e.alternate = null), Ud(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[mt], delete t[Nr], delete t[mu], delete t[Xg], delete t[Ug])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Te(e, t) {
  ...
  if (r === 0)
    ...
    if ((n != null && wa(n), t === 1))
      e.tag === 0 ? Tg(dc.bind(null, e)) : Yf(dc.bind(null, e)),
        Og(function () {
          !(X & 6) && tn();
        }),
        (n = null);
...
function bd(e, t) {
  ...
  if (r & 30 || r & e.expiredLanes || t) t = mo(e, r);
    ...
    X |= 2;
    var o = Gd();
    (fe !== e || he !== t) && ((Vt = null), ($n = re() + 500), cn(e, t));
    do
      try {
        ov();
        break;
    ...
    vs(),
      (Ao.current = o),
      (X = i),
      oe !== null ? (t = 0) : ((fe = null), (he = 0), (t = se));
  }
  if (t !== 0) {
    if (
      (t === 2 && ((i = su(e)), i !== 0 && ((r = i), (t = Xu(e, i)))), t === 1)
    )
      throw ((n = jr), cn(e, 0), Lt(e, r), Te(e, re()), n);
    if (t === 6) Lt(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = i), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = vu(rn.bind(null, e, Oe, Vt), t);
            break;
          }
          rn(e, Oe, Vt);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = vu(rn.bind(null, e, Oe, Vt), r);
            break;
          }
          rn(e, Oe, Vt);
          break;
  ...
  return Te(e, re()), e.callbackNode === n ? bd.bind(null, e) : null;
}
function Xu(e, t) {
  var n = qr;
  return (
...
function dc(e) {
  ...
  if (n === 1) throw ((n = jr), cn(e, 0), Lt(e, t), Te(e, re()), n);
...
function Gn() {
  if (bt !== null) {
    var e = Ef(vo),
      ...
      n = D;
    try {
      if ((($e.transition = null), (D = 16 > e ? 16 : e), bt === null))
        var r = !1;
      else {
        if (((e = bt), (bt = null), (vo = 0), X & 6)) throw Error(R(331));
        var i = X;
        ...
        if (
          ((X = i), tn(), yt && typeof yt.onPostCommitFiberRoot == "function")
        )
          try {
            yt.onPostCommitFiberRoot(Vo, e);
          } catch {}
        r = !0;
      }
      return r;
...
function uv(e, t, n) {
  ...
  r !== null && r.delete(t),
    ...
    fe === e &&
      (he & n) === n &&
      (se === 4 || (se === 3 && (he & 130023424) === he && 500 > re() - Ks)
        ? cn(e, 0)
        : (Is |= n)),
    Te(e, t);
}
function Md(e, t) {
  t === 0 &&
    (e.mode & 1
      ...
      : (t = 1));
  var n = qe();
  (e = Kt(e, t)), e !== null && (ti(e, t, n), Te(e, n));
}
function sv(e) {
  var t = e.memoizedState,
    n = 0;
...
Oo.prototype.render = Ts.prototype.render = function (e) {
  var t = this._internalRoot;
  if (t === null) throw Error(R(409));
  xo(e, t, null, null);
};
Oo.prototype.unmount = Ts.prototype.unmount = function () {
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (is(t, n | 1), Te(t, re()), !(X & 6) && (($n = re() + 500), tn()));
      }
      break;
    case 13:
      vn(function () {
...
var vc = Gl;
(Nl.createRoot = vc.createRoot), (Nl.hydrateRoot = vc.hydrateRoot);
...
function xv() {
  this.visibilityState === "hidden" && Tu && (Uo = !0);
}
function Ov(e) {
...
function vr(e, t) {
  return Mv(bo("", null, null, "", null, null, 0), e, { length: -e.length }, t);
}
function Hv() {
  return ie;
}
function _v() {
  return (
    (ie = We > 0 ? ve(or, --We) : 0), tr--, ie === 10 && ((tr = 1), Do--), ie
  );
}
function Ge() {
  return (
    (ie = We < op ? ve(or, We++) : 0), tr++, ie === 10 && ((tr = 1), Do++), ie
  );
}
function Ct() {
  return ve(or, We);
...
function lp(e) {
  return (Do = tr = 1), (op = gt((or = e))), (We = 0), [];
}
function up(e) {
  return (or = ""), e;
}
function Gi(e) {
  return ip(oi(We - 1, Lu(e === 91 ? e + 2 : e === 40 ? e + 1 : e)));
}
function $v(e) {
  for (; (ie = Ct()) && ie < 33; ) Ge();
...
function e0(e, t) {
  ...
  return oi(e, Ni() + (t < 6 && Ct() == 32 && Ge() == 32));
}
function Lu(e) {
  for (; Ge(); )
    switch (ie) {
...
function wc(e, t, n, r, i, o, l, u, s, a, g) {
  for (
    ...
    for (var f = 0, c = Hr(e, p + 1, (p = Zv((v = l[m])))), A = e; f < y; ++f)
      (A = ip(v > 0 ? d[f] + " " + c : W(c, /&\f/g, d[f]))) && (s[E++] = A);
  return bo(e, t, n, i === 0 ? bs : u, s, a, g);
}
function i0(e, t, n) {
  return bo(e, t, n, np, Lo(Hv()), Hr(e, 2, -2), 0);
}
function Cc(e, t, n, r) {
  return bo(e, t, n, Ns, Hr(e, 0, r), Hr(e, r + 1, -1), r);
}
function Jn(e, t) {
...
var s0 = function (t, n, r) {
  ...
  a0 = function (t, n) {
    ...
    do
      switch (_r(i)) {
        case 0:
          i === 38 && Ct() === 12 && (n[r] = 1), (t[r] += s0(We - 1, n, r));
          break;
        case 2:
          t[r] += Gi(i);
          break;
...
function sp(e, t) {
  switch (Qv(e, t)) {
    ...
    case 4765:
      if (gt(e) - 1 - t > 6)
        switch (ve(e, t + 1)) {
          ...
          case 115:
            return ~Wu(e, "stretch")
              ? sp(W(e, "stretch", "fill-available"), t) + e
              : e;
        }
      break;
    case 4949:
    ...
    case 6444:
      switch (ve(e, gt(e) - 3 - (~Wu(e, "!important") && 10))) {
        case 107:
          return W(e, ":", ":" + U) + e;
        case 101:
          return (
    ...
    if (t.length > -1 && !t.return)
      switch (t.type) {
        case Ns:
          ...
          break;
        case rp:
          return Jn([vr(t, { value: W(t.value, "@", "@" + U) })], i);
        case bs:
          if (t.length)
                ...
                case "::placeholder":
                  return Jn(
                    [
                      ...
                      vr(t, { props: [W(o, /:(plac\w+)/, ":" + yo + "$1")] }),
                      vr(t, { props: [W(o, /:(plac\w+)/, Re + "input-$1")] }),
                    ],
                    i
                  );
              }
 ...
 */ var de = typeof Symbol == "function" && Symbol.for,
  ...
  No = de ? Symbol.for("react.fragment") : 60107,
...
b.AsyncMode = Ms;
b.ConcurrentMode = Qo;
b.ContextConsumer = Mo;
b.ContextProvider = Zo;
b.Element = Js;
b.ForwardRef = jo;
b.Fragment = No;
b.Lazy = _o;
...
var Qs = function () {
  ...
  Sc = function (t) {
    return typeof t == "string" && t.charCodeAt(0) > 96 ? T0 : W0;
  },
  kc = function (t, n, r) {
    var i;
    if (n) {
          ...
          u &&
            ...
            w.push((I) => {
              ...
              if (T) {
                const M = {};
                return (
                  Object.entries(T).forEach(([le, pe]) => {
                    M[le] =
...
const Uc = Bt.createContext(null);
function W1(e) {
  if (e === void 0)
...
var N1 =
  ...
  na = (function (e) {
    ...
    function t(r, i) {
      ...
      var l = o.handleExited.bind(W1(o));
      return (
        (o.state = {
    ...
    return (
      ...
      (t.getDerivedStateFromProps = function (i, o) {
        var l = o.children,
          u = o.handleExited,
          s = o.firstRender;
        return { children: s ? D1(i, u) : b1(i, l, u), firstRender: !1 };
      }),
      ...
      (n.render = function () {
        var i = this.props,
          ...
          a = N1(this.state.children).map(l);
        return (
          delete u.appear,
          delete u.enter,
          delete u.exit,
          o === null
            ? Bt.createElement(Uc.Provider, { value: s }, a)
            : Bt.createElement(
                Uc.Provider,
                { value: s },
                Bt.createElement(o, u, a)
              )
        );
      }),
      t
...
function Z1(e) {
  ...
  return (
    ...
    ce("span", {
      className: d,
      style: y,
      children: ce("span", { className: m }),
    })
  );
}
const M1 = Wo("MuiTouchRipple", [
    "root",
    "ripple",
    "rippleVisible",
    "ripplePulsate",
      ...
      f = S.useCallback(
        (h = {}, w = {}, V = () => {}) => {
          ...
          if (
            ...
            (M = Math.round(T.width / 2)), (le = Math.round(T.height / 2));
          else {
            const { clientX: nt, clientY: Se } =
              h.touches && h.touches.length > 0 ? h.touches[0] : h;
            (M = Math.round(nt - T.left)), (le = Math.round(Se - T.top));
          }
          if (k)
            (pe = Math.sqrt((2 * T.width ** 2 + T.height ** 2) / 3)),
              pe % 2 === 0 && (pe += 1);
          else {
            const nt =
    ...
    return (
      ...
      ce(
        ...
        K({ className: xe(je.root, o.root, l), ref: v }, u, {
          children: ce(J1, { component: null, exit: !0, children: s }),
        })
      )
    );
  }),
...
const ih = Wo("MuiButtonBase", ["root", "disabled", "focusVisible"]),
  oh = ih,
  lh = [
    "action",
    "centerRipple",
  ...
  ah = S.forwardRef(function (t, n) {
    const r = sl({ props: t, name: "MuiButtonBase" }),
      ...
      B = S.useRef(null),
      F = mc(B, pe),
      { isFocusVisibleRef: x, onFocus: N, onBlur: Q, ref: zt } = Xv(),
      [Ae, dt] = S.useState(!1);
    a && Ae && dt(!1),
    ...
    return Mi(
      ...
      K(
        ...
        lr,
        Se,
        { children: [l, si ? ce(nh, K({ ref: F, center: o }, le)) : null] }
      )
    );
  }),
  ch = ah;
...
const Vh = Wo("MuiButton", [
  ...
  Ih = S.forwardRef(function (t, n) {
    const r = S.useContext(Bh),
      ...
      V = Sh(w),
      C = f && ce(Ph, { className: V.startIcon, ownerState: w, children: f }),
      k = y && ce(qh, { className: V.endIcon, ownerState: w, children: y });
    return Mi(
      kh,
      K(
        {
...
function zh() {
  ...
  M == null && localStorage.setItem("currentSessionScratchCardCode", T);
  const le = l[Number(M)];
  ...
  console.log("🚀 ~ file: App.js:62 ~ App ~ deviceWidth", N);
  let Q = N < 500;
...
function Uh() {
  Nl.createRoot(document.getElementById("scratch-card-app-root")).render(
    ce(zh, {})
  );
}
let Pp = !1;
